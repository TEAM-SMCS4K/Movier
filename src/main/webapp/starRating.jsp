...
<div style="display: flex; align-items: center;">
    ...
    <div class="rating">
        ...
        <label class="rating__label rating__label--half" for="star1half">
            <input type="radio" id="star1half" class="rating__input" name="starRating" value="1.5">
            <span class="star-icon"></span>
        </label>
        ...
        <label class="rating__label rating__label--half" for="star2half">
            <input type="radio" id="star2half" class="rating__input" name="starRating" value="2.5">
            <span class="star-icon"></span>
        </label>
        ...
        <label class="rating__label rating__label--half" for="star3half">
            <input type="radio" id="star3half" class="rating__input" name="starRating" value="3.5">
            <span class="star-icon"></span>
        </label>
        ...
        <label class="rating__label rating__label--half" for="star4half">
            <input type="radio" id="star4half" class="rating__input" name="starRating" value="4.5">
            <span class="star-icon"></span>
        </label>
